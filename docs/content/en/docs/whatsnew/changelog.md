...
* Due to a bug introduced in Cilium 1.14, present in EKS Anywhere `v0.21.0`-`v0.21.6`, we recommend that you upgrade to `v0.21.7` or above if you are using hostport in your applications. More details listed [here](https://github.com/aws/eks-anywhere-build-tooling/pull/4330)
